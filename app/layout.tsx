...
export const metadata: Metadata = {
  ...
  description: 'Custom web development, mobile apps, AI/ML integrations, and innovative software solutions for students and enterprises.',
  keywords: 'web development, mobile apps, AI, ML, capstone projects, software agency',
}
