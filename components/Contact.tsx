          ...
          >
            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  link: 'https://t.me/+3rWsIOATWNs0NGFl',
                  gradient: 'from-purple-500 to-pink-500',
                },
                {
                  icon: Linkedin,
                  label: 'LinkedIn',
                  value: 'Connect with Lunor',
                  link: 'https://www.linkedin.com/in/lunorko',
                ...
                },
                {
                  ...
                  label: 'Instagram',
                  value: '@lunor.ko',
                  link: 'https://www.instagram.com/lunor.ko?igsh=YWJiMHA3bTI1bGNj',
            ...
            >
              ...
              <div className="flex gap-4">
                {[
                  { name: 'X', href: 'https://x.com/Lunor_ko' },
                  { name: 'LinkedIn', href: 'https://www.linkedin.com/in/lunorko' },
                  { name: 'Instagram', href: 'https://www.instagram.com/lunor.ko?igsh=YWJiMHA3bTI1bGNj' },
                  { name: 'Telegram', href: 'https://t.me/+3rWsIOATWNs0NGFl' },
                ].map((social) => (
                  <motion.a
                    key={social.name}
                    href={social.href}
