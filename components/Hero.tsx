    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            Led by expert developers and innovators, we transform ideas into cutting-edge digital experiences with custom development, machine learning, and automation solutions
          </motion.p>
          ...
          >
            ...
            <motion.a
              href="#portfolio"
              className="px-8 py-4 glass-effect rounded-full text-white font-semibold neon-border hover:bg-white/10 transition-all"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Explore Our Work
