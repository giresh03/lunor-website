...
const services = [
  ...
  },
  {
    ...
    shortDesc: 'High-impact ad campaigns that grow your brand fast.',
    fullDesc:
      'We craft and optimize digital ad campaigns across Google, Meta, and emerging platforms to reach your ideal audience and deliver measurable ROI. From creative to analytics, we handle every part of the funnel.',
    features: [
      'Performance Campaign Strategy',
      'Creative & Copy Iterations',
