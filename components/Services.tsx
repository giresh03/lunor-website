...
const services = [
  ...
  },
  {
    ...
    shortDesc: 'Complete digital marketing solutions to grow your brand and reach your audience.',
    fullDesc:
      'We provide comprehensive digital marketing services including SEO optimization, social media management, content marketing, email campaigns, and performance advertising. Our data-driven approach ensures maximum ROI across Google Ads, Meta Ads, LinkedIn, and emerging platforms. From strategy to execution and analytics, we handle every aspect of your digital presence.',
    features: [
